import cv2
import numpy as np
image = cv2.imread("E:/Computer Vision/computer vision input and output/27.cut crop paste input 1.jpeg")
img2 = cv2.imread("E:/Computer Vision/computer vision input and output/27.cut crop paste input 2.jpeg")
print(image.shape) 
